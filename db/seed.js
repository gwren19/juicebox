...
const createInitialUsers = async () => {
    try {
        ...
        await createUser({ username: 'albert', password: 'bertie99', name:'albert', location:'' });
        await createUser({ username: 'sandra', password: '2sandy4me', name:'albert', location:'' });
        await createUser({ username: 'glamgal', password: 'soglam', name: 'albert', location:'' });
